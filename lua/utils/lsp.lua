...
M.on_attach = function(client, bufnr)
	...
	keymap("n", "<leader>gd", "<cmd>Telescope lsp_definitions<CR>", opts) -- LSP Definitions
	keymap("n", "<leader>gr", "<cmd>Telescope lsp_references<CR>", opts) -- Show all references to the symbol under the cursor
	keymap("n", "<leader>gt", "<cmd>Telescope lsp_type_definitions<CR>", opts) -- Jump to the type definition of the symbol under the cursor
	keymap("n", "<leader>ds", "<cmd>Telescope lsp_document_symbols<CR>", opts) -- List all symbols (functions, classes, etc.) in the current file
	keymap("n", "<leader>ws", "<cmd>Telescope lsp_workspace_symbols<CR>", opts) -- Search for any symbol across the entire project/workspace
	keymap("n", "<leader>gi", "<cmd>Telescope lsp_implementations<CR>", opts) -- Go to implementation
